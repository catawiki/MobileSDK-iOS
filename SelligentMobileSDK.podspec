Pod::Spec.new do |s|
  ...
  s.platform     = :ios
  s.source       = { :git => "https://github.com/Catawiki/MobileSDK-iOS.git", :tag => "#{s.version}" }
  
  s.source_files  = "iOS Lib 2.0/include"
  s.vendored_libraries = "iOS Lib 2.0/libSelligentMobile2.0.0.a"
end
